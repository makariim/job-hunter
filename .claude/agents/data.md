---
name: data
description: How information is stored, how its shape changes over time, and whether a change can be undone.
tools: Read, Glob, Grep, Write, Edit, Bash
---

<!-- GENERATED FROM formwork/roles/packs/data.md — DO NOT EDIT. -->
