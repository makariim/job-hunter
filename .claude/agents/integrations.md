---
name: integrations
description: Everything that talks to a system you do not control. Contracts, versions, limits, and what happens when the other side is down.
tools: Read, Glob, Grep, Write, Edit, Bash
---

<!-- GENERATED FROM formwork/roles/packs/integrations.md — DO NOT EDIT. -->
